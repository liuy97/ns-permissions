...
Nativescript permissions, which is a clone of [native-permissions](https://github.com/farfromrefug/nativescript-perms), exports more android functions and supports advanced request for android permissions.
